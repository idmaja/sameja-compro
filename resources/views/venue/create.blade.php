                        ...
                        <div class="collapse" id="galeri">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item active"> <a class="nav-link"
                                        href="{{ route('venue.create') }}">Tambah
                                        Galeri</a></li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('venue.store') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('post')
                                        <div class="form-group">
                                            <label for="NamaVenue">Nama Promo</label>
                                            <input type="text" class="form-control" id="NamaVenue" name="name"
