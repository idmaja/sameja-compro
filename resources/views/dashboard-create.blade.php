                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item active"> <a class="nav-link"
                                        href="{{ route('menu.land') }}">Daftar Menu</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="galeri">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('venue.land') }}">Daftar
                                        Galeri</a></li>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('dashboard.store') }}"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="NamaMenu"
                                                            name="name" placeholder="Nama pemesan">
                                                        @error('name')
                                                            <small>{{ $message }}</small>
                                                        @enderror
                                                        <label for="Harga">Terbayar</label>
                                                        <input type="text" class="form-control" id="Harga"
                                                            name="price" placeholder="Uang terbayar">
                                                        @error('price')
                                                            <small>{{ $message }}</small>
                                                        @enderror
                                                        <label for="pembayaran">Pembayaran</label>
                                                        <input type="text" class="form-control" id="Harga"
                                                            name="check" placeholder="Jenis pelunasan">
                                                        @error('check')
                                                            <small>{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        {{-- @foreach ($history as $h)
                                                            <label for="date">{{ $h->created_at }}</label>
                                                        @endforeach
                                                        <br> --}}
                                                        <label for="catatan">Catatan</label>
                                                        <textarea type="textarea" class="form-control" id="catatan" placeholder="Catatan" name="note"></textarea>
                                                        @error('note')
                                                            <small>{{ $message }}</small>
                                                        @enderror
                                                    </div>
