                        ...
                        <div class="collapse" id="promo">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item active"> <a class="nav-link"
                                        href="{{ route('promo.create') }}">Tambah
                                        Promo</a></li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('promo.store') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('post')
                                        <div class="form-group">
                                            <label for="NamaPromo">Nama Promo</label>
                                            <input type="text" class="form-control" id="NamaPromo" name="name"
                                        ...
                                        @enderror
                                        <div class="form-group">
                                            <label for="DescPromo">Deskripsi</label>
                                            <input type="text" class="form-control" id="DescPromo"
                                                name="description" placeholder="Deskripsi Promo">
                                        </div>
                                        @error('description')
                                            <small>{{ $message }}</small>
                                        @enderror
