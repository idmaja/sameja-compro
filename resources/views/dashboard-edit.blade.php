                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <form class="forms-sample"
                                            action="{{ route('dashboard.update', $data->id) }}" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="NamaMenu"
                                                                name="name" placeholder="Nama Menu"
                                                                value="{{ $data->name }}">
                                                            @error('name')
                                                                <small>{{ $message }}</small>
                                                            @enderror
                                                            ...
                                                            <input type="text" class="form-control" id="Harga"
                                                                name="check" placeholder="Pembayaran"
                                                                value="{{ $data->check }}">
                                                            @error('check')
                                                                <small>{{ $message }}</small>
                                                            @enderror
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="textarea" class="form-control" id="catatan" placeholder="Catatan" name="note">{{ $data->note }}</textarea>
                                                            @error('note')
                                                                <small>{{ $message }}</small>
                                                            @enderror
                                                        </div>
