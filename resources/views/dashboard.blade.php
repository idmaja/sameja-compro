                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-5">
                                                <input type="text" class="form-control" id="search"
                                                    name="search" placeholder="Masukkan nama pemesan">
                                            </div>
                                            <div class="col">
                                                <input type="submit"
                                                    class="btn btn-primary items-center justify-center"
                                                    value="Cari">
                                            </div>
                                        </div>
                                    </form>
                                    <h4 class="card-title">List</h4>
                                    <a class="btn btn-success" href="{{ route('dashboard-create') }}"><b>
                                            Tambah</b></a>
                                            ...
                                            <tbody>
                                                @foreach ($history as $h)
                                                    <tr>
                                                        <td>{{ $h->id }}</td>
                                                        <td>{{ $h->name }}</td>
                                                        <td>{{ $h->FormatRupiah('price') }}</td>
                                                        <td>{{ $h->check }}</td>
                                                        <td>{{ $h->created_at->format('d M Y') }}</td>
                                                        <td>{{ $h->note }}</td>
                                                        <td><a href="{{ route('dashboard-edit', $h->id) }}"
                                                                class="btn btn-primary">Edit</a>
                                                            <a href="{{ route('dashboard.delete', $h->id) }}"
                                                                class="btn
                                                                btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
